...
public class Fight {
	...
	private void move(Ants ants, Map.Entry<Tile, Aim> entry, Tile myFightingAnt,
 Tile nearestEnemy, boolean isLosing) {
		final List<Aim> directions = ants.getDirections(myFightingAnt, nearestEnemy);
		if (isLosing) {
